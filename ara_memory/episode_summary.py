        ...
        *,
        ...
        for cap in candidates:
            ...
            if current is None or current["status"] != MemoryStatus.CANDIDATE.value:
                group.blocked_reason = "episode summary blocked: source capsule changed before consolidation"
                return None
        ...
        for cap in candidates:
            ...
            if not changed:
                ...
                group.blocked_reason = "episode summary blocked: source capsule changed during consolidation"
                return None
        return summary
