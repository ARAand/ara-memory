...
- `reconsolidation-frame` is read-only. It can gather purpose, identity, settled-decision, failure/conflict, working-context, and forgetting-boundary evidence, but it cannot promote, supersede, rewrite, delete, or cool capsules.
